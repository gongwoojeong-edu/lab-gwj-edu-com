...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.paragraph_flow_progress TO authenticated;
GRANT ALL ON public.paragraph_flow_progress TO service_role;
...
GRANT SELECT, INSERT ON public.memorization_recordings TO authenticated;
GRANT ALL ON public.memorization_recordings TO service_role;
