...
export const PraiseSparkle = ({ grade, text }: Props) => {
  ...
  const slots = useMemo(
    () =>
      Array.from({ length: SPARKLE_SLOTS(grade) }, () => {
  ...
  if (!visible && grade !== "excellent" && grade !== "good") return null;
        ...
        <div className="min-w-0">
          <div
            className={cn(
              ...
              GRADIENT[grade] ?? "text-foreground",
            )}
          >
            {text}
          </div>
